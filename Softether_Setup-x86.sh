...
#Download SoftEther
wget http://www.softether-download.com/files/softether/v4.15-9546-beta-2015.04.05-tree/Linux/SoftEther_VPN_Server/32bit_-_Intel_x86/softether-vpnserver-v4.15-9546-beta-2015.04.05-linux-x86-32bit.tar.gz
sleep 5
#Extract SoftEther
tar -xzvf softether-vpnserver-v4.15-9546-beta-2015.04.05-linux-x86-32bit.tar.gz
sleep 5
#Compile SoftEther
cd vpnserver
yes 1 | make
